...
namespace DungeonInventory
{
    ...
    public class MainGame : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (!mapEditor.isActive && !inventoryDisplay.isActive)
            {
            ...
            if (newKBState.IsKeyDown(xnai.Keys.Tab) && !oldKBState.IsKeyDown(xnai.Keys.Tab) && !inventoryDisplay.isActive)
            {
                mapEditor.Active();
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (inventoryDisplay.isActive)
                inventoryDisplay.Draw(spriteBatch, Font);
